...
P2-3 生产影子与 P2-5 受保护主路径双端门禁均已于 2026-08-12 通过，见[代理分类技术方案](docs/跨平台共享核心P2代理分类技术方案.md)与[P2-5 验收记录](docs/跨平台共享核心P2-5验收记录-2026-08-12.md)。P2-6 允许共享识别成功时不再计算原生分类，但未识别类型和所有共享错误必须且只能执行一次原生回退；不得删除原生分类、P2-4 路由或差分测试，也不得把 DIRECT、REJECT 或未知静默并入 Proxy。
