...
P2-3 生产影子、P2-5 受保护主路径与 P2-7 最终双端门禁均已于 2026-08-12 通过，见[代理分类技术方案](docs/跨平台共享核心P2代理分类技术方案.md)与[P2-7 验收记录](docs/跨平台共享核心P2-7验收记录-2026-08-12.md)。生产保持共享识别成功不计算原生分类；未识别类型和所有共享错误必须且只能执行一次原生回退。不得删除原生分类、P2-4 路由或差分测试，也不得把 DIRECT、REJECT 或未知静默并入 Proxy。
