...
QUOTA_REQUIRED_APP_FILES = (
    ...
    "Presentation/ProfileDirectoryChoiceDialog.xaml",
    "Presentation/ProfileDirectoryChoiceDialog.xaml.cs",
...
QUOTA_REQUIRED_CODE_MARKERS = {
    ...
    APP_ROOT / "Presentation/ProfileDirectoryChoiceDialog.xaml": (
        "Clash Verge Rev",
        "%APPDATA%\\io.github.clash-verge-rev.clash-verge-rev",
        "%APPDATA%\\top.gydi.clashverge",
        "SuggestedDirectoryButton_Click",
        "浏览其他目录",
    ),
    APP_ROOT / "Presentation/ProfileDirectoryChoiceDialog.xaml.cs": (
        "ShouldOpenPicker",
